...
struct CharInfo {
	...
	static CharInfo byChar(int c) {
		...
		case 'ч': info.dots = CH; break;
		case 'ш': info.dots = SH; break;
		case 'щ': info.dots = SCH; break;
		case 'ъ': info.dots = HARDSIGN; break;
		case 'ы': info.dots = YI; break;
		case 'ь': info.dots = SOFTSIGN; break;
		case 'э': info.dots = YE; break;
		case 'ю': info.dots = YU; break;
		case 'я': info.dots = YA; break;
